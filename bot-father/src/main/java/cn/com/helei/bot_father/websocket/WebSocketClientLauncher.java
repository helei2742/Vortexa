...
public class WebSocketClientLauncher {
     ...
     * 已启动的ws客户端
     */
    private final Map<String, cn.com.helei.bot_father.websocket.BaseBotWSClient<?, ?>> launchedWSClientMap = new ConcurrentHashMap<>();
    ...
    private @NotNull CompletableFuture<Result> buildAndConnectWebSocket(
        ...
        //  Step 2 启动
        cn.com.helei.bot_father.websocket.BaseBotWSClient<?, ?> wsClient = null;
     ...
     * @param autoBotJobWSParam autoBotJobWSParam
     */
    private <Req, Resp> void init(cn.com.helei.bot_father.websocket.BaseBotWSClient<Req, Resp> wsClient, AutoBotJobWSParam autoBotJobWSParam, Semaphore wsConnectSemaphore) {
        // 设置参数
