...
public class NameserverClient extends AbstractWebsocketClient<RemotingCommand> {
     ...
     * @return response
     */
    public RemotingCommand tryResolveCustomRequest(RemotingCommand remotingCommand) throws CustomCommandException {
        return customCommandProcessor.tryInvokeCustomCommandHandler(remotingCommand);
    }
}
